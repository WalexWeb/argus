...
import { AlertsTable, AlertCards } from '@/components/AlertsList';
  ...
  return (
    <>
      ...
      <section className="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card padding>
          <div className="rounded-lg bg-gradient-to-br from-rose-500/20 to-rose-600/10 p-4">
        ...
        <Card padding>
          <div className="rounded-lg bg-gradient-to-br from-amber-500/20 to-amber-600/10 p-4">
        ...
        <Card padding>
          <div className="rounded-lg bg-gradient-to-br from-yellow-500/20 to-yellow-600/10 p-4">
        ...
        <Card>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {rules.rules.map((rule) => (
              <div
                key={rule.rule}
                className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5 transition hover:border-pistachio-500/20 hover:bg-white/[0.03]"
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1">
                    ...
                    <p className="mt-1.5 text-sm text-zinc-500 font-mono text-xs">
                      {rule.rule}
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-3 rounded-lg bg-black/30 p-3">
                  ...
                  <code className="block font-mono text-xs leading-relaxed text-pistachio-400/80 break-words">
                    {rule.condition}
                  </code>
                </div>
                {rule.action && (
                  <div className="mt-2 rounded-lg bg-white/[0.02] p-3">
